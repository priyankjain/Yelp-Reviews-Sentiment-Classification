...
if __name__ == "__main__":
	if len(sys.argv) != 4:
		...
		hmeans = [list() for i in range(0, 5)]
		hmeans[0].append([0.39, 0.305, 0.335, 0.445, 0.395, 0.525, 0.395, 0.415, 0.38, 0.3])
		hmeans[1].append([0.365, 0.24, 0.41, 0.375, 0.425, 0.445, 0.335, 0.47, 0.48, 0.17])
		hmeans[2].append([0.405, 0.245, 0.4, 0.34, 0.375, 0.475, 0.35, 0.455, 0.435, 0.255])
		hmeans[3].append([0.31, 0.355, 0.34, 0.385, 0.42, 0.425, 0.41, 0.425, 0.395, 0.3])
		hmeans[4].append([0.235, 0.205, 0.22, 0.24, 0.185, 0.265, 0.22, 0.22, 0.355, 0.125])
		hmeans[0].append([0.39, 0.345, 0.38, 0.34, 0.34, 0.3, 0.26, 0.29, 0.24, 0.225])
		hmeans[1].append([0.245, 0.43, 0.42, 0.25, 0.355, 0.185, 0.35, 0.36, 0.24, 0.215])
		hmeans[2].append([0.265, 0.315, 0.405, 0.195, 0.305, 0.195, 0.36, 0.36, 0.26, 0.3])
		hmeans[3].append([0.215, 0.27, 0.245, 0.17, 0.19, 0.145, 0.165, 0.24, 0.165, 0.205])
		hmeans[4].append([0.165, 0.14, 0.175, 0.185, 0.125, 0.18, 0.14, 0.205, 0.13, 0.17])
		hmeans[0].append([0.155, 0.23, 0.325, 0.25, 0.225, 0.285, 0.18, 0.235, 0.275, 0.225])
		hmeans[1].append([0.105, 0.12, 0.36, 0.225, 0.13, 0.195, 0.285, 0.145, 0.18, 0.255])
		hmeans[2].append([0.125, 0.145, 0.33, 0.24, 0.14, 0.185, 0.175, 0.155, 0.255, 0.17])
		hmeans[3].append([0.125, 0.15, 0.19, 0.105, 0.12, 0.16, 0.14, 0.155, 0.105, 0.115])
		hmeans[4].append([0.085, 0.105, 0.11, 0.05, 0.085, 0.12, 0.115, 0.105, 0.05, 0.105])
		hmeans[0].append([0.23, 0.19, 0.265, 0.21, 0.185, 0.245, 0.16, 0.24, 0.205, 0.275])
		hmeans[1].append([0.125, 0.12, 0.21, 0.13, 0.135, 0.27, 0.1, 0.12, 0.13, 0.08])
		hmeans[2].append([0.165, 0.105, 0.2, 0.09, 0.115, 0.235, 0.095, 0.14, 0.105, 0.12])
		hmeans[3].append([0.1, 0.115, 0.1, 0.08, 0.135, 0.14, 0.11, 0.105, 0.095, 0.06])
		hmeans[4].append([0.095, 0.07, 0.07, 0.07, 0.085, 0.105, 0.09, 0.07, 0.045, 0.06])
